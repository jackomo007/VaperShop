                    	...
                    	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateContainer">
                        	<!-- <tr>
                            	<td align="center" valign="top">
                                    ...
                                    <!-- // AQUI VA LA IMAGEN Begin Template Header \\ -->
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Recibo de pago en VAPERSHOP</h1>

                                                                <strong>Saludos, {{auth()->user()->name}}</strong> 
                                                                Aqui estan los datos de tu compra, muchas gracias por preferirnos.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                          ...
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              ...
                                                              <tr >
                                                                <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                    DIRECCIÓN A DONDE SE HARÁ LA ENTREGA
                                                                </td>
                                                                ...
                                                                <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                              	...
                                                              	<td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                   PERSONA QUE RECIBIRÁ LA ENTREGA
                                                                </td>
                                                                ...
                                                                <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                   CANTIDAD EXACTA DE DINERO PARA EL CAMBIO
                                                                </td>

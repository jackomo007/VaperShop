                        ...
                        <div class="row">
                                    ...
                                    <div class="profile-sidebar-inner brd-rd5">
                                        <div class="user-info red-bg">
                                            ...
                                            <div class="user-info-inner">
                                                ...
                                                <span><a href="#" title=""
                                                        itemprop="url">dum3@chimpgroou.com</a></span>
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#cat" data-toggle="tab"><i
                                                        class="fa fa-dashboard"></i> AGREGAR CATEGORÍAS</a>
                                            </li>
                                            <li><a href="#editc" data-toggle="tab"><i
                                                        class="fa fa-file-text"></i> EDITAR CATEGORÍAS</a>
                                            </li>
                                            <li><a href="#addproduc" data-toggle="tab"><i
                                                        class="fa fa-comments"></i> AGREGAR PRODUCTOS</a>
                                            </li>
                                            <li><a href="#editproduc" data-toggle="tab"><i
                                                        class="fa fa-shopping-basket"></i> EDITAR
                                                    PRODUCTOS</a></li>
                                            <li><a href="#otros" data-toggle="tab"><i class="fa fa-cog"></i>
                                                    OTRAS CONFIGURACIONES</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8 col-sm-12 col-lg-8">
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="cat">
                                        <div class="dashboard-wrapper brd-rd5" style="padding:0px">
                                            <div class="welcome-note yellow-bg brd-rd5">
                                                ...
                                                <p itemprop="description">Administra tus productos aquí</p>
                                    ...
                                    <div class="tab-pane fade" id="addproduc">
                                        <div class="tabs-wrp brd-rd5">
                                    ...
                                    <div class="tab-pane fade" id="editproduc">
                                        <div class="tabs-wrp brd-rd5">
                                            <h4 itemprop="headline">EDITAR PRODUCTOS</h4>
                                            <form class="restaurant-info-form brd-rd5">
                                                <div class="row mrg20">
                                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                                        <label>Nombre de Producto<sup>*</sup></label>
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                                        <div class="step-buttons">
                                                            <a class="brd-rd3 red-bg" href="#" title=""
                                                                itemprop="url">Guardar Cambios</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-lg-8">
                                                        <div class="profile-info-form-wrap">
                                                            <form class="profile-info-form">
                                                                <div class="row mrg20">
                                                                    <a class="red-clr change-password"
                                                                        href="#" title=""
                                                                        itemprop="url">Cambiar tu
                                                                        contraseña</a><br><br>
                                                                    <a class="red-clr change-password"
                                                                        href="#" title=""
                                                                        itemprop="url">Cambiar tu
                                                                        foto de perfil</a><br><br>
                                                                    <a class="red-clr change-password"
                                                                        href="#" title=""
                                                                        itemprop="url">Cambiar tu
                                                                        correo eléctrónico</a>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
